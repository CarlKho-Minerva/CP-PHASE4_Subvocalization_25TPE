// ============================================================================
// LEVEL 1: OVERT SPEECH CAPTURE - Speaking Out Loud (Calibration)
// ============================================================================
#include <iostream>
#include <fstream>
#include <string>
...
const std::string OUTPUT_FILE = "overt_data.csv";
const int CYCLES = 10;

struct Phase { std::string label; int duration; std::string instruction; };
const std::vector<Phase> PHASES = {
    {"GHOST", 3, "SAY 'GHOST' OUT LOUD - Normal speaking voice"},
    {"LEFT",  3, "SAY 'LEFT' OUT LOUD - Normal speaking voice"},
    {"STOP",  3, "SAY 'STOP' OUT LOUD - Normal speaking voice"},
...
int main() {
    ...
    std::cout << "╔══════════════════════════════════════════════════════════════╗\n";
    std::cout << "║  LEVEL 1: OVERT SPEECH (Speaking Out Loud)                   ║\n";
    std::cout << "╚══════════════════════════════════════════════════════════════╝\n\n";
    ...
    std::cout << "\n✅ Overt Speech Complete! → " << OUTPUT_FILE << "\n";
