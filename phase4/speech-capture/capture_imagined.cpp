// ============================================================================
// LEVEL 5: IMAGINED SPEECH - Pure Mental Imagination (No Movement)
// ============================================================================
#include <iostream>
#include <fstream>
#include <string>
...
const std::string OUTPUT_FILE = "imagined_data.csv";
const int CYCLES = 10;

struct Phase { std::string label; int duration; std::string instruction; };
const std::vector<Phase> PHASES = {
    {"GHOST", 3, "IMAGINE 'GHOST' - No tongue movement, pure mental!"},
    {"LEFT",  3, "IMAGINE 'LEFT' - Like reading to yourself silently"},
    {"STOP",  3, "IMAGINE 'STOP' - Hear it in your head, don't move"},
    {"REST",  3, "Relax completely. Empty mind."}
};
...
int main() {
    ...
    std::cout << "╔══════════════════════════════════════════════════════════════╗\n";
    std::cout << "║  LEVEL 5: IMAGINED SPEECH (Pure Mental - No Movement!)       ║\n";
    std::cout << "╚══════════════════════════════════════════════════════════════╝\n\n";
    ...
    std::cout << " Done.\n\n>>> PURELY MENTAL - NO TONGUE MOVEMENT! <<<\n";
    std::cout << ">>> Like reading silently to yourself <<<\n\nStarting in 3..."; std::cout.flush();
    ...
    std::cout << "\n✅ Imagined Speech Complete! → " << OUTPUT_FILE << "\n";
