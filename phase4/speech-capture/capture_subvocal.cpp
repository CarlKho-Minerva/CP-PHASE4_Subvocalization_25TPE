// ============================================================================
// LEVEL 4: SILENT ARTICULATION CAPTURE - Closed-Mouth (TESTING DATA)
// ============================================================================
...
// "Silent Articulation" = Closed-mouth speech with exaggerated internal tongue movement
// ============================================================================
...
// SAME words as mouthing, but with closed-mouth instructions
// ============================================================================
struct Phase {
    std::string label;
    int duration;
...
const std::vector<Phase> PHASES = {
    {"GHOST", 3, "SUBVOCALIZE 'GHOST' - Lips CLOSED, exaggerate tongue→palate internally"},
    {"LEFT",  3, "SUBVOCALIZE 'LEFT' - Lips CLOSED, exaggerate tongue→ridge internally"},
    {"STOP",  3, "SUBVOCALIZE 'STOP' - Lips CLOSED, exaggerate plosive internally"},
...
int main() {
    ...
    std::cout << "╔══════════════════════════════════════════════════════════════╗\n";
    std::cout << "║  LEVEL 4: SILENT ARTICULATION CAPTURE (Testing Data)         ║\n";
    std::cout << "║  Closed-mouth, exaggerate INTERNAL tongue movements           ║\n";
    std::cout << "╚══════════════════════════════════════════════════════════════╝\n\n";
    ...
    // 4. Main Loop
    std::cout << "\n>>> REMEMBER: LIPS CLOSED, tongue movement INTERNAL! <<<\n";
    std::cout << ">>> Do the SAME tongue gymnastics as mouthing, just inside! <<<\n\n";
    ...
    std::cout << "\n✅ Silent Articulation Capture Complete! Data saved to " << OUTPUT_FILE << "\n";
    std::cout << "You now have training (mouthing) + testing (subvocal) data!\n";
    close(serial_fd);
    csv_file.close();
    return 0;
}
